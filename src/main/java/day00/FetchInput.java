...
public class FetchInput {
  ...
  private File getFile(String day, String example) {
    if (example.equals("0"))
      return getResource((day.length()==1 ? "/Day0" : "/Day") + day + "/input.txt");
    return getResource((day.length()==1 ? "/Day0" : "/Day") + day + "/example-"+example+".txt");
  }
